...
Revision ID: 594c8d0afd56
Revises: 
Create Date: 2019-02-21 17:20:13.639548
...
def upgrade():
    ...
    op.create_index(op.f('ix_post_deleted_timestamp'), 'post', ['deleted_timestamp'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_post_deleted_timestamp'), table_name='post')
    op.drop_table('post')
